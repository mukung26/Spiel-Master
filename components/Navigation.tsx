...
import { MessageSquare, Languages, LayoutGrid, Bug, Scissors } from 'lucide-react';
...
export const Navigation: React.FC<NavigationProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <nav className="w-full md:w-72 bg-white dark:bg-[#202124] border-t md:border-t-0 md:border-r border-gray-100 dark:border-gray-800 flex flex-col transition-colors duration-300">
      {/* Tools Header (Matches Sidebar.tsx style) */}
      <div className="p-4 pl-6 border-b border-gray-100 dark:border-gray-800 hidden md:block">
         <h3 className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Workspace Tools</h3>
      </div>
