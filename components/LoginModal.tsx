...
export const LoginModal: React.FC<LoginModalProps> = ({ onClose, onGoogleLogin, onAdminLogin }) => {
  ...
  const handleAdminSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        // Snapshot the whole accounts node (assuming reasonably small user base)
            ...
            <form onSubmit={handleAdminSubmit} className="space-y-4 animate-in slide-in-from-right duration-200">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold uppercase tracking-wide transition-all shadow-lg shadow-blue-500/30 disabled:opacity-70"
                >
